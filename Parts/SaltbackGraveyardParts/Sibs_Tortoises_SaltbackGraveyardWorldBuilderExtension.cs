...
namespace Tortoises.Sibs
{
    [JoppaWorldBuilderExtension]
    public class Sibs_Tortoises_SaltbackGraveyardWorldBuilderExtension : IJoppaWorldBuilderExtension
    {
        public override void OnAfterBuild(JoppaWorldBuilder builder)
        {
            ...
            cell.GetFirstObjectWithPart("TerrainTravel")?.AddPart<Sibs_Tortoises_SaltbackGraveyardTerrain>(new Sibs_Tortoises_SaltbackGraveyardTerrain());
            ...
            zoneManager.AddZonePostBuilder(zoneID, "MapBuilder", "FileName", "Sibs_SaltbackGraveyard.rpm");
            zoneManager.AddZonePostBuilder(zoneID, "Music", "Track", "Music/tortoises/Baud.mp3");
            zoneManager.AddZonePostBuilder(zoneID, "AddWidgetBuilder", "Blueprint", "Sibs_Tortoises_SaltbackGraveyardSurface");
