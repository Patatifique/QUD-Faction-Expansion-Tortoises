...
{
    [Serializable]
    public class Sibs_Tortoises_SaltbackGraveyardTerrain : IPart
    {
        ...
        public override bool FireEvent(Event E)
        {
            if (E.ID == "SaltbackGraveyardReveal")
            {
                ...
                this.ParentObject.GetPart<Description>().Short = "Nestled between wind-shaped dunes, a concealed valley holds an ocean of bones, a testament to the fleetingness of life in Qud.";
